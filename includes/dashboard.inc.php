...
?>
		...
		<div id="content" data-uk-height-viewport="expand: true" style="height:100%; display:block;">
			<div style="margin-top:20px;" class="uk-container uk-container-expand">
<?php
...
?>
				<footer class="uk-section uk-section-small uk-width-1-1 uk-text-center donotprint">
					<hr>
					<p class="uk-text-center">Tournoi de Palet par Yoan Guillot - <a href="https://www.lepaletdutrefle.fr">Le Palet du Trèfle</a> - version BETA 0.21
					</p>
				</footer>

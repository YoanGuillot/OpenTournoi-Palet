		...
		<div class="uk-card uk-card-default uk-card-hover">
			...
			<div class="uk-card-body uk-text-center">
				<div class="uk-grid uk-grid-large">
					...
					<div class="uk-panel"><a href="index.php" class="uk-icon-link" title="Quitter le turnoi" data-uk-tooltip data-uk-icon="icon: sign-out;ratio: 3"></a><br />Quitter le tournoi</div>
				</div>
			</div>
		</div>
	</div>

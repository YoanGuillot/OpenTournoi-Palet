		...
		<div class="uk-card uk-card-default uk-card-hover">
			...
			<div class="uk-card-body uk-text-center">
				<div class="uk-grid uk-grid-large">
					...
					<div class="uk-panel"><a href="#" class="uk-icon-link generate-web-btn-gestion" title="Générer site Web" data-idtournoi="<?= $idTournoi ?>" data-uk-tooltip data-uk-icon="icon: cloud-upload;ratio: 3"></a><br />Générer site Web</div>
